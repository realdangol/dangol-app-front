...
const CartBottomFixed = () => {
  return (
    <div className="fixed bottom-0 left-0 right-0 h-[66px] bg-white px-m flex justify-between items-center shadow-[0px_0px_2px_0px_#0000001F] shadow-[0px_0px_8px_0px_#0000001A] rounded-t-lg">
